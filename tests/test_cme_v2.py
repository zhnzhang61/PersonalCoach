...
def mem(tmp_path):
    ...
    # conflict_context. As of PR P2 _SCHEMA_SQL canonically includes
    # related_models / event_timestamp columns + topic_episode_links,
    # and MemoryOS.__init__ migrates legacy DBs, so this fixture only
    # needs the topics rebuild. (See `test_cme_v2b.py` for the same
    # pattern — both files were created when _SCHEMA_SQL was thinner.)
